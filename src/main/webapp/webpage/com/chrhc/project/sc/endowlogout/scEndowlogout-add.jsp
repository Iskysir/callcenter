...
<link href="plug-in/media/css/default.css" rel="stylesheet" type="text/css" id="style_color"/> 
 ...
 <body style="overflow-y: scroll" >
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="scEndowlogoutController.do?doAdd" tiptype="1">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="name" name="name" class="form-control w260" value="${scEndowlogoutPage.name }" readonly="readonly" nullmsg="请输入参保人姓名！" datatype="*1-50" type="text">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="cancelldate" name="cancelldate" class="form-control w260" onclick="WdatePicker({errDealMode:1,maxDate:'%y-%M-%d'})" readonly="readonly" nullmsg="请输入注销日期！" datatype="date" type="text">
								<span style="color: red;">*</span>
								<span class="Validform_checktip"></span>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="beniname" name="beniname" class="form-control w260" value="" readonly="readonly" nullmsg="请输入受益人姓名！" datatype="*1-50" validtype="sc_endowlogout,rk_id,id" type="text">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="benibirthday" name="benibirthday" class="form-control w260" onclick="WdatePicker({errDealMode:1,maxDate:'%y-%M-%d'})" readonly="readonly" nullmsg="请输入受益人出生日期！"  datatype="date" type="text">
								<span class="Validform_checktip"></span>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="beniidcard" name="beniidcard" class="form-control w260" value="" nullmsg="请输入受益人身份证号！" validtype="sc_endowlogout,beniidcard,id"  readonly="readonly" datatype="idcard" type="text">
								<span style="color: red;">*</span>
								<span class="Validform_checktip"></span>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="paddress" name="paddress" class="form-control w260" value="" nullmsg="请输入户籍所在地！" ignore="ignore" datatype="*1-50" type="text">
								<span class="Validform_checktip"></span>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="telphone" name="telphone" class="form-control w260" value="" nullmsg="请输入联系人电话！" ignore="ignore" datatype="tel" type="text">
								<span class="Validform_checktip"></span>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="address" name="address" class="form-control w260" value="" nullmsg="请输入居住地址！" ignore="ignore" datatype="*1-50" type="text">
								<span class="Validform_checktip"></span>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input id="bankcode" name="bankcode" class="form-control w260" value="" nullmsg="请输入银行账号！" ignore="ignore" datatype="*1-50" type="text">
								<span class="Validform_checktip"></span>
