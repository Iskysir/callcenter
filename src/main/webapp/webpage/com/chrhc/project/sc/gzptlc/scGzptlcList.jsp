 ...
 <div class="Current_position">
    	<img src="plug-in/media/image/dingwei.png"/><span>当前所在的位置：</span>
     	 ...
     	 <a href="javascript:;">个人办公</a>&nbsp;
     	  <a href="javascript:;">待审核列表</a>
    </div>
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
  <t:datagrid name="scGzptlcList" checkbox="true" fitColumns="true" title="电子资料" actionUrl="scGzptlcController.do?getdatas&url=http://10.61.160.7:8280/cpub-back-web/api/app/netservice/declare/tasklist" idField="id" fit="true" queryMode="group" sortOrder="desc" sortName="createDate">
  ...
  <%---<t:dgCol title="实例ID"  field="instance_id" hidden="true"   width="120"></t:dgCol>
   ...
   <t:dgToolBar title="审批" icon="icon-edit" url="scGzptlcController.do?goUpdate&flag=up&url=http://10.61.160.7:8280/cpub-back-web/api/app/netservice/declare/get/" funname="update" ></t:dgToolBar>
     </t:optAuthFilter>
...
function scGzptlcListsearch(idcard){

	var url="&url=http://10.61.160.7:8280/cpub-back-web/api/app/netservice/declare/tasklist";
	var url_ ="scGzptlcController.do?getdatas&declare_per_name=";
	var declare_per_name = $("input[name='declare.per.name']").val();
	if(idcard){
		declare_id_num=idcard;
		 $("input[name='declare.id.num']").val(idcard);
	}
