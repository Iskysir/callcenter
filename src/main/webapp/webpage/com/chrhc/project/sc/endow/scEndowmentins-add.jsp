...
<link href="plug-in/media/css/default.css" rel="stylesheet" type="text/css" id="style_color"/> 
 ...
 <body style="overflow-y: scroll" >
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="scEndowmentinsController.do?doAdd" tiptype="1">
		  ...
		  <div class="tab-content tab-box">
		    ...
		    <div class="tab-pane active" id="jbxx">
				  ...
				  <div class="container form-card">
					<input id="btn_sub" class="btn_sub" type="hidden">
					<input name="tableName" value="sc_endowmentins" type="hidden">
					<input name="layerId" value="" type="hidden">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="code" class="form-control w260" id="code" type="text" value="" nullmsg="请输入养老保险编号！" validType="sc_endowmentins,code,id" datatype="*1-50">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="idcard" readonly="readonly" class="form-control w260" id="idcard" type="text" value="" nullmsg="请输入身份证号！" datatype="idcard" validType="sc_endowmentins,idcard,id">
									<span style="color: red;">*</span>
									<span class="Validform_checktip"></span>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="insureddate" class="form-control w260" id="insureddate" onclick="WdatePicker({errDealMode:1,maxDate:'%y-%M-%d'})" type="text"  nullmsg="请输入参保日期！" datatype="date">
									<span style="color: red;">*</span>
									<span class="Validform_checktip"></span>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="birthday"  class="form-control w260" id="birthday" onclick="WdatePicker({errDealMode:1,maxDate:'%y-%M-%d'})" type="text" nullmsg="请输入出生日期！" datatype="date">
									<span class="Validform_checktip"></span>
