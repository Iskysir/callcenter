...
<script src="plug-in/chrhc/jquery.lazyload.js"></script>
 ...
 <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="kinshipController.do?doAdd" tiptype="4" beforeSubmit="addbeforeSubmit">
		...
		<!--  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">-->
			...
			<div class="form-group">
						...
						<t:dictSelect field="gxlx" type="list"
									typeGroupCode="qsgx" defaultVal="${kinshipPage.gxlx}" hasLabel="false"  title="关系类型" extendJson="{'datatype':'*'}"></t:dictSelect>     
			...
			<div class="form-group">
						<label class="control-label" for="name">姓名</label> 
							<input id="name" name="name" type="text" class="form-control w260" onclick="inputClick(this,'xm','sc_rkjbxxnew','name=xm,qsId=id,sex=xb','{&quot;singleSelect&quot;:true}') " datatype="*1-100" readonly="readonly">
			...
			<div class="form-group">
						<label class="control-label" for="name">备注</label> 
							 <textarea class="form-control" rows="3" cols="80" id="bz" name="bz" datatype="*1-200" ignore="ignore"></textarea>
							<span class="Validform_checktip"></span>
