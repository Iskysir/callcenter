...
<script src="plug-in/Validform/js/Validform_v5.3.1.js" type="text/javascript"></script>
  ...
  $(document).ready(function(){
	...
	$("#sourcetable").val('${scEwmnrxpzPage.sourcetable}').attr('class', 'form-control w260').css('background-color','#ffffff');
  });
...
function delLine(){ 
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="4" action="scEwmnrxpzController.do?doUpdate">
	...
	<div class="container form-card">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<input id="ywbh" name="ywbh" type="text" class="form-control w260" validtype="sc_ewmnrxpz,ywbh,id" datatype="w1,s2-30" value='${scEwmnrxpzPage.ywbh}'>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<input id="ywmc" name="ywmc" type="text" class="form-control w260" ignore="ignore"  datatype="*1-30" value='${scEwmnrxpzPage.ywmc}'>
					<span class="Validform_checktip"></span>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<input id="frontfield" name="frontfield" type="text" class="form-control w260" datatype="*1-30" value='${scEwmnrxpzPage.frontfield}'>
					<span class="Validform_checktip"></span>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<textarea id="remark" class="form-control" rows="3" cols="80" ignore="ignore" datatype="*1-200" name="remark">${scEwmnrxpzPage.remark}</textarea>
					<span class="Validform_checktip"></span>
												...
												<c:forEach items="${scEwmnrxpzsubList}" var="poVal" varStatus="stuts">
													<tr id="trDemo">
														...
														<td class="center"><input type="checkbox" name="ck" /></td>
														   ...
														   <td>
															  <input name="scEwmnrxpzsubList[${stuts.index }].nrxcode" maxlength="36" id="fieldcode'${stuts.index }'" type="text" readonly="true" class="form-control" datatype="*1-36" value="${poVal.nrxcode }">
														   ...
														   <td>
															  <input name="scEwmnrxpzsubList[${stuts.index }].remark" maxlength="300"  type="text" class="form-control" ignore="ignore" datatype="*1-200" value="${poVal.remark }">
		...
		<tbody id="add_scEwmnrxpzsub_table_template" class="checkboxchrhc">
			<tr>
			 ...
			 <td class="center"><input type="checkbox" name="ck" /></td>
				  <td>
					  <input name="scEwmnrxpzsubList[#index#].nrxcode" maxlength="36" id="fieldcode#index#" type="text" readonly="true" class="form-control"  datatype="*1-36">
					  <label class="Validform_label" style="display: none;">内容项代码</label>
				  </td>
				  <td>
				  		<input name="scEwmnrxpzsubList[#index#].nrxname" type="hidden" />
						<select id="fieldname#index#" name="nrxnamehidden#index#" datatype="*1-100" class="form-control" ignore="ignore" onchange="getcode(this)">
							<option value="">---请选择---</option>
						</select>
					  <label class="Validform_label" style="display: none;">内容项名称</label>
				  </td>
				  <td>
					  <input name="scEwmnrxpzsubList[#index#].remark" maxlength="200" ignore="ignore"  type="text" class="form-control"  datatype="*1-200" />
					  <label class="Validform_label" style="display: none;">备注</label>
				  </td>
			</tr>
		 </tbody>
