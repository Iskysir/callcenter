...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hlSatisfiedDegreeController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="degeree" name="degeree" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.degeree}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="stState" name="stState" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.stState}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="yxgzl" name="yxgzl" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.yxgzl}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="wxgzl" name="wxgzl" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.wxgzl}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sxgzl" name="sxgzl" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.sxgzl}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="visitPerson" name="visitPerson" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.visitPerson}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="visitTime" name="visitTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${hlSatisfiedDegreePage.visitTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="visitInput" name="visitInput" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlSatisfiedDegreePage.visitInput}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="inputTime" name="inputTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${hlSatisfiedDegreePage.inputTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="visitOption" style="width:600px;" class="inputxt" rows="6" name="visitOption">${hlSatisfiedDegreePage.visitOption}</textarea>
							<span class="Validform_checktip"></span>
