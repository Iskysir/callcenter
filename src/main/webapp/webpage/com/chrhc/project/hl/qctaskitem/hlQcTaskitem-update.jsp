...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hlQcTaskitemController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orderid" name="orderid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlQcTaskitemPage.orderid}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="ordertype" name="ordertype" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlQcTaskitemPage.ordertype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="avsorce" name="avsorce" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${hlQcTaskitemPage.avsorce}'>
							<span class="Validform_checktip"></span>
