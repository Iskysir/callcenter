...
<section id="mainbox"> 
  	<div class="tab-content tab-box chrhc_tabs_box">
        <ul class="nav nav-tabs chrhc_tabs">
            ...
            <li id="rwclLi"><a href="javascript:void(0);" onclick="showTaskOperate()" data-toggle="tab">任务处理</a></li>
	...
	<script type="text/javascript">
	 $(document).ready(function() { 
		...
		var obj = $("iframe[src^='taskController.do?goTaskTab']",window.parent.document);
		...
		objParent.css("padding","0px");
		 	...
		 	$.ajax({  
		        ...
		        dataType:"html",
		        async:  false ,
		        url:"taskController.do?goTaskForm&taskId=${taskId}",       
		...
		function showTaskOperate(){
			...
			//alert("showTaskOperate");
		 	$.ajax({  
		        ...
		        dataType:"html",
		        async:  false ,
		        url:"taskController.do?goTaskOperate&taskId=${taskId}",       
		        success:function(data){
		        	//alert(data);
