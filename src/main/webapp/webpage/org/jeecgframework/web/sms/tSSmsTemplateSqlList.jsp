...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsTemplateSqlList" checkbox="true" title="消息模板_业务SQL配置表" actionUrl="tSSmsTemplateSqlController.do?datagrid" idField="id" fit="true" queryMode="group">
