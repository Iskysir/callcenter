...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding: 1px;">
        <t:datagrid name="departList" title="组织机构管理"
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                <!--<a href="#" class="easyui-linkbutton icon-add l-btn l-btn-plain" plain="true" icon="icon-add" onclick="addOrg()"><t:mutiLang langKey="common.add.param" langArg="common.department"/></a>
                <a href="#" class="easyui-linkbutton icon-edit l-btn l-btn-plain" plain="true" icon="icon-edit" onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','departController.do?update','departList')"><t:mutiLang langKey="common.edit.param" langArg="common.department"/></a>-->
            </div>
        </div>
    </div>
</div>
