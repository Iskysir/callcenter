...
<t:formvalid formid="formobj" layout="div" dialog="true" refresh="true" action="territoryController.do?saveTerritory">
	...
	<input name="territoryPinyin" type="hidden" value="${territory.territoryPinyin}">
	<!--<input name="xwgs84" type="hidden" value="${territory.xwgs84}">
	<input name="ywgs84" type="hidden" value="${territory.ywgs84}">-->
	<fieldset class="step">
        <div class="form">
		...
		<div class="form" id="funordera">
			<label class="Validform_label">经度: </label>
			<input name="xwgs84" class="inputxt" value="${territory.xwgs84}">

		</div>
		<div class="form" id="funorderb">
			<label class="Validform_label">维度: </label>
			<input name="ywgs84" class="inputxt" value="${territory.ywgs84}">
		</div>
	</fieldset>
</t:formvalid>
</body>
