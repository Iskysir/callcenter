...
<div region="center" style="padding: 1px;">
    <t:datagrid name="iconList" title="图标管理" actionUrl="iconController.do?datagrid" idField="id">
        ...
        <t:dgCol title="common.icon" field="iconPath" image="true" ></t:dgCol>
        ...
        <t:dgToolBar title="batch.generate.style" icon="icon-piliang" url="iconController.do?repair" funname="doSubmit"></t:dgToolBar>
    </t:datagrid>
</div>
</div>
