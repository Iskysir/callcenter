	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" colspan="3">
				...
				<option value="Y" <c:if test="${cgreportConfigHeadPage.pagination eq 'Y'}"> selected='selected'</c:if> ><t:mutiLang langKey="common.yes"/></option>
				<option value="N" <c:if test="${cgreportConfigHeadPage.pagination eq 'N'}"> selected='selected'</c:if> ><t:mutiLang langKey="common.no"/></option>
			</select></td>
		</tr>
