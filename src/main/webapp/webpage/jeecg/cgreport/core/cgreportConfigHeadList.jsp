...
<t:datagrid  checkbox="true" name="cgreportConfigHeadList" title="dynamic.table.head" actionUrl="cgreportConfigHeadController.do?datagrid"
	idField="id" fit="true" queryMode="group">
	<t:dgCol title="" field="id" hidden="true" queryMode="single" width="120" ></t:dgCol>
	<t:dgCol title="common.code" field="code" query="true" queryMode="single"  ></t:dgCol>
	<t:dgCol title="common.name" field="name" query="true" queryMode="single"  ></t:dgCol>
	<t:dgCol title="query.sql" field="cgrSql" query="true" queryMode="single"  ></t:dgCol>
	<t:dgCol title="common.description" field="content" query="true" queryMode="single"  ></t:dgCol>
	<t:dgCol title="common.operation" field="opt" width="75"></t:dgCol>
