...
<h3>简介</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JEECG 业务流程构建平台，引领新开发模式(智能开发\在线开发\插件开发)， 可以帮助解决Java项目60%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。 <br>
&nbsp;&nbsp;&nbsp;&nbsp;JEECG快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流来实现、扩展出任务接口，供开发编写业务逻辑。 实现了流程任务节点和任务接口的灵活配置，既保证了公司流程的保密性，又减少了开发人员的工作量</p>
<h3>架构说明</h3>
<ul>
	<li>JEECG 业务流程构建平台，采用SpringMVC+MiniDao+UI快速开发库+ OnlineCoding开发组件 的基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、<br>
...
<h3>技术交流</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商业版新增功能（工作流组件+数据权限+强大报表+国际化），通过购买商业版本可享受更多的功能、技术支持 ;</b></p>
<ul>
	<li>商务 QQ  : 418799587</li>
	<li>商务邮箱 ：jeecg@sina.com</li>
	<li>论    坛 ： <a href="http://www.jeecg.org">www.jeecg.org</a></li>
	<li>服    务 ： 一次授权 | 终身使用| 免费升级</li>
</ul>
</div>