...
<head>
    ...
    <script type="text/javascript">
        ...
        var MACHINE_SN= 'machine0001';//机器唯一标识
        var agentno_1="";
        var dialOutNum="";
        var agent_id,exten;
        var ringType="";
...
}catch(e)
{
                ...
                }else if(eventCmdType=="bridge")//通话开始
                {
                    ...
                    $.post("${ctx}/softphone/saveHisCall.do",{"uuidA":uuidA,"uuidB":uuidB,"cm_id":cm_id,"cm_code":cm_code,"cm_name":cm_name,"cm_tel":cm_tel,"calledNum":callcenterNum,"business_id":top.business_id,"business_code":top.business_code,"yw_code":top.yw_code,"callType":callType},function(result){
                        //alert(result);
                    });
