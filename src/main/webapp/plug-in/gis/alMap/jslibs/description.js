var DemoDescription = {};
//地图
DemoDescription['LoadMap'] = {title: '加载地图', desc: '定义：。', oper: '' }
DemoDescription['addBasicLayer'] = {title: '添加图层', desc: '定义：', oper: '' }
DemoDescription['layerControl'] = {title: '图层控制', desc: '定义：', oper: '' }
DemoDescription['measure'] = {title: '测量', desc: '定义：', oper: '无' }
DemoDescription['drawLayer'] = {title: '画图', desc: '定义：', oper: '无' }
DemoDescription['showCenter'] = {title: '展示地图中心点', desc: '定义：', oper: '无' }
DemoDescription['centerTo'] = {title: '定位到某个位置', desc: '定义：', oper: '无' }
DemoDescription['addInfoWindow'] = {title: '添加弹出窗口', desc: '定义：', oper: '无' }

DemoDescription['editMarkerLayer'] = {title: '编辑图标图层', desc: '当处于可编辑状态，鼠标拖动某个实体便可以进行移动，移动结束后执行回调方法，进行数据的更新', oper: '' }
DemoDescription['addMarkerLayer'] = {title: '添加图标图层', desc: '', oper: '' }
DemoDescription['addTextLayer']={title:'添加文本图层',desc:'', oper: '' }
DemoDescription['addComplexLayer'] = {title: '添加复合图层', desc: '', oper: '' }
DemoDescription['EditGraphicsModule'] = {title: '点线面绘制', desc: '点绘制结束后，通过拖动可改变原有位置', oper: '' }
DemoDescription['editShapeLayer'] = {title: '编辑线面图层', desc: '对于已经存在的线面图层，可以通过该功能进行坐标的重新编辑', oper: '' }
...
DemoDescription['zoom range'] = {title: '设置缩放级别', desc: '定义：此范例展示设置地图的缩放级别，初始化时地图的缩放级别为0,缩放级别的数量为5。', oper: '通过鼠标滑动放大缩小。' }
DemoDescription['coordinate transformation '] = {title: '坐标转换', desc: '定义：此范例展示像素坐标与地理坐标之间的转换。', oper: '通过鼠标点击地图。' }
...
DemoDescription['markerEvent'] = {title: '标记图层事件', desc: '此范例展示标记图层支持的简单的事件，在marker上添加click事件（移动端浏览器则注册touchstart事件），弹出一个简单的信息框。', oper: '点击“加载数据” 按钮，加载数据后点击marker图标，触发事件，弹出简单信息框。' }
...
DemoDescription['featureSnap'] = {title: '要素编辑', desc: '此范例展示捕捉类和控件ModifyFeature进行要素编辑和捕捉。',oper:'点击“编辑"按钮，可以对面图层进行修改，点击“切换捕捉”来开启与关闭捕捉。'}
...
DemoDescription['cartoCSS_edit'] = {title: 'CartoCSS编辑', desc: '定义：前端CartoCSS符号系统编辑，用户可在编辑框内输入CartoCSS样式，通过选择器，以及设置CartoCSS样式属性来定义某一图层的样式符号，可对地图的渲染样式进行重新定制。', oper: '在编辑框内输入合法的CartoCSS样式表，或者修改原有的CartoCSS，比如修改颜色值、线宽等等属性，对地图样式进行重新定义。' }
