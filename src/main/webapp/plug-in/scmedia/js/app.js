    ...
    var handleSidebarToggler = function () {
		...
		$(".container-fluid").on('click', '.sid', function (e) {            
            ...
            if (body.hasClass("page-sidebar-closed")) {
            	...
            	$("#collapse_div").mCustomScrollbar("destroy");
                body.addClass("page-sidebar-closed");
            }
			...
			$(".tablesiframe").width(width-30);
			$(" .tabs-panels").width(width-10);
			$("#maintabs").children(" .tabs-panels").children(" .panel").children(" .panel-body-noheader").width(width-10);
