...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() <  available_height) {
                content.attr('style', 'height:' + available_height + 'px');
            }
        } else {
    ...
    var handleSidebarToggler = function () {
		...
		$(".container-fluid").on('click', '.sid', function (e) {            
            var body = $('body');
            var sidebar = $('.page-sidebar');
            ...
            if (body.hasClass("page-sidebar-closed")) {
				...
				var url = $('.sidebar-menu_1 li').children('a').children('.img_url').attr('url');
				var src = $('.sidebar-menu_1 li').children('a').children('.img_url').children('img').attr('src');
				$('.sidebar-menu_1 li').children('a').children('.img_url').children('img').attr('src',url);
				$('.sidebar-menu_1 li').children('a').children('.img_url').attr('url',src);
