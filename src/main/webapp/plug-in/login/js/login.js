...
function setCookie()
{
	if ($('#on_off').attr("checked") == 'checked') {
		$("input[iscookie='true']").each(function() {
			$.cookie(this.name, $("#"+this.name).val(), { expires: 7 });
...
function loading(name, overlay) {
	...
	$('body').append('<div id="overlay" ></div><div id="preloader" style="width:120px;margin: auto;padding-top: -100px;color: white;font-family :"Microsoft YaHei">' + name + '..</div>');
	if (overlay == 1) {
