		...
		$.extend($.Datatype,{
			...
			*/
			...
			"tel":function(gets,obj,curform,datatype){
				 ...
				 var mobile=/^((\+?86)|(\(\+86\)))?(13[0123456789][0-9]{8}|15[012356789][0-9]{8}|18[02356789][0-9]{8}|147[0-9]{8}|1349[0-9]{7})$/;    	
				//var mobile =  /^(00|0536)?(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
				 //var tel = /^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?$/;
				 if(mobile.test(gets)||tel.test(gets)){ 
				        return true; 
				    } 
				    else{ 
				        return false; 
			...
			"mobile":function(gets,obj,curform,datatype){


				var mobile=/^((\+?86)|(\(\+86\)))?(13[0123456789][0-9]{8}|15[012356789][0-9]{8}|18[012356789][0-9]{8}|147[0-9]{8}|1349[0-9]{7})$/;
