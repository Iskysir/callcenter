...
<html>
 ...
 <body>
  <form id="formobj" action="chrhcFormBuildController.do?saveOrUpdateMore" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub"/>
		...
		$.dialog.confirm("确认删除该条记录?", function(){
			...
			<div style="width: auto;height: 200px;">
				...
				<#list subtablelist as sub >
					<#if sub_index=0>
						<div title="${head.content}" style="margin:0px;padding:0px;overflow:hidden;">
