								...
								<#if po.field_valid_type?if_exists?html != ''>
					               ...
					               <#if po.is_null != 'Y'>datatype="*"</#if> 
									...
									<#if dictdata.typecode?if_exists?html=="${field_value}"> selected="selected" </#if>
									 ...
									 <#else>
									 <#if dictdata.typecode?if_exists?html=="${po.field_default??}"> selected="selected" </#if>
									 </#if>
									>
										${dictdata.typename?if_exists?html}
									</option> 
					    ...
					    <a href="javascript:void(0)"  class="camerabtn-new inner-newbtn" plain="true" icon="icon-search" onClick="selectdoctype('${po.field_name}','${po.gis_attr?if_exists?html}','1')" id="adddoc" title='拍照'></a>
					    <a href="javascript:void(0)" style="display:none"  class="seebtn-new inner-newbtn" plain="true" icon="icon-search" onClick="selectdoctype('${po.field_name}','${po.gis_attr?if_exists?html}','2')" id="editdoc" title='查看'></a>		
						...
						<#elseif po.show_type=='file'>
							<div style="float: left; margin-left: 6px;" id="filetype">
								...
								<div style="float:left;margin-left:6px;">
									<ul>
										<#list filesList as fileB>
											...
											<li>
												<span class="picName" style="color: black"><i class="glyphicon glyphicon-picture"></i>&nbsp;${fileB['title']}</span>
												...
												<a id="uploadify_a_${po.field_name}" href="javascript:void(0);" onclick="delFile('cgUploadController.do?delFile&id=${fileB['fileKey']}',this)" class="btn btn-default delflag" >删除</a>
											</li>
											</#if>
										</#list>
									</ul>
