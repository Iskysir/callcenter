...
public class CgAutoListConstant {
	/**表单弹出属性**/
	public static final String POPUPATTR = "popup_attr";
	/**表单验证属性**/
	public static final String VALIDATEATTR = "validate_attr";
	/**其他扩展属性**/
	public static final String GISATTR = "gis_attr";
	/** 配置的id */
	...
	public static final String FIELD_MAINQUERY = "field_mainQuery";
	/** 字段href */
	...
	//WXCH 14.07.14  add start
	/** sql增强delete */
	public static final String SQL_DELETE = "delete";
	//WXCH 14.07.14  add end
