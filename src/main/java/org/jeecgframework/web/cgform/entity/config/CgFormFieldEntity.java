...
public class CgFormFieldEntity implements java.io.Serializable {
	...
	/**主表名编号*/
	private java.lang.String mainTableCode;
	/**主表名*/
	...
	/**表单验证扩展属性**/
	private java.lang.String validateAttr;
	
	/**popup属性**/
	private java.lang.String popupAttr;
	/**主要查询**/
	private java.lang.String mainQuery;
	
	
	@Column(name ="main_tablecode")
	public java.lang.String getMainTableCode() {
		return mainTableCode;
	}

	public void setMainTableCode(java.lang.String mainTableCode) {
		this.mainTableCode = mainTableCode;
	}

	@Column(name ="popup_attr")
	public java.lang.String getPopupAttr() {
		return popupAttr;
	}

	public void setPopupAttr(java.lang.String popupAttr) {
		this.popupAttr = popupAttr;
	}

	/**gis扩展属性**/
	private java.lang.String gisAttr;
	@Column(name ="gis_attr")
	public java.lang.String getGisAttr() {
		return StringUtil.isEmpty(gisAttr)?"":gisAttr;
	}

	public void setGisAttr(java.lang.String gisAttr) {
		this.gisAttr = gisAttr;
	}

	@Column(name ="validate_attr")
	public java.lang.String getValidateAttr() {
		return validateAttr;
	}

	public void setValidateAttr(java.lang.String validateAttr) {
	...
	@Column(name ="main_query")
	public java.lang.String getMainQuery() {
		return mainQuery;
	}

	public void setMainQuery(java.lang.String mainQuery) {
