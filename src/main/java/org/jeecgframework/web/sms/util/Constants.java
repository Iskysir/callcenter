...
public class Constants {
	//邮件发送配置
		...
		//短信网关发送方式配置
		public static final String SMS_WEB_ACCOUNT = "sms.web.account";
		public static final String SMS_WEB_PASSWORD = "sms.web.password";
		public static final String SMS_WEB_LONGSEND = "sms.web.longsend";
		public static final String SMS_WEB_70SEND = "sms.web.70send";
		/**
		 * 未发送
		 */
