 ...
 */
@Controller
@RequestMapping("/cgReportControllerHl")
public class CgReportControllerHl extends BaseController {
	@Autowired
	...
	public void popup(String id, HttpServletRequest request,
		...
		String html = viewEngine.parseTemplate("/org/jeecgframework/web/cgreport/engine/core/cgreportlistpopuphl.ftl", cgReportMap);
		try {
			response.setContentType("text/html");
			response.setHeader("Cache-Control", "no-store");
			PrintWriter writer = response.getWriter();
