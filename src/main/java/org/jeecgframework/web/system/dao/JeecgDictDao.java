...
public interface JeecgDictDao {
	...
	@ResultType("org.jeecgframework.web.system.pojo.base.DictEntity")
	public List<DictEntity> queryCustomDict(String dicTable, String dicCode,String dicText);
	
	
	@Arguments({"dicTable", "dicCode", "dicText","whereStr"})
	@ResultType("org.jeecgframework.web.system.pojo.base.DictEntity")
	public List<DictEntity> queryCustomDictByWhereStr(String dicTable, String dicCode,String dicText,String whereStr);
