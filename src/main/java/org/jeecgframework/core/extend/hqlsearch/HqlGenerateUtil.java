...
public class HqlGenerateUtil {
	...
	private static void installHqlJoinAlias(CriteriaQuery cq, Object searchObj,
			...
			Map<String, String[]> parameterMapFinal, String alias) {
		Map<String, String[]> parameterMap=new HashMap<String,String[]>();
		if(parameterMapFinal!=null)
			parameterMap.putAll(parameterMapFinal);
		...
		for (int i = 0; i < origDescriptors.length; i++) {
			...
			if(name.equalsIgnoreCase("delflag"))
			{
				try {
					PropertyUtils.setProperty(searchObj, "delflag", "0");
