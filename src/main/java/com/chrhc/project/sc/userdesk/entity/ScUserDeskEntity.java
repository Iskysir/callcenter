package com.chrhc.project.sc.userdesk.entity;
 ...
 */
@Entity
@Table(name = "sc_user_desk", schema = "")
@SuppressWarnings("serial")
public class ScUserDeskEntity implements java.io.Serializable {
	/**主键*/
	...
	/**图标*/
	@Excel(name="图标")
	private java.lang.String deskIcon;
	/**用户id*/
	@Excel(name="用户id")
	 ...
	 */
	@Column(name ="DESK_ICON",nullable=true,length=50)
	public java.lang.String getDeskIcon(){
	 ...
	 */
	public void setDeskIcon(java.lang.String deskIcon){
