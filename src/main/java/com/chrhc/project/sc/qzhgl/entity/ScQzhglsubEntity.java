 ...
 */
@Entity
@Table(name = "sc_qzhglsub", schema = "")
@SuppressWarnings("serial")
public class ScQzhglsubEntity implements java.io.Serializable {
	/**主键*/
	...
	/**提供*/
	@Excel(name="提供")
	private java.lang.String isExist;
	/**备注*/
	@Excel(name="备注")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  提供
	 */
	@Column(name ="IS_EXIST",nullable=false,length=10)
	public java.lang.String getIsExist(){
		return this.isExist;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  提供
	 */
	public void setIsExist(java.lang.String isExist){
