 ...
 * @date 2015-08-25 13:17:29
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sc_ywlxpzxsub", schema = "")
@SuppressWarnings("serial")
public class ScYwlxpzxsubEntity implements java.io.Serializable {
	/**主键*/
	...
	/**配置项*/
	private java.lang.String pzxId;
	/**排序号*/
	@Excel(name="排序号")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  配置项
	 */
	@Column(name ="PZX_ID",nullable=true,length=36)
	public java.lang.String getPzxId(){
		return this.pzxId;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  配置项
	 */
	public void setPzxId(java.lang.String pzxId){
		this.pzxId = pzxId;
	}
	/**
	 *方法: 取得java.lang.Integer
	 ...
	 */
	@Column(name ="SORT_NO",nullable=false,length=9)
