 ...
 *
 */
public class ScQzhglPage implements java.io.Serializable {
	/**保存-签章管理子项*/
	private List<ScQzhglsubEntity> scQzhglsubList = new ArrayList<ScQzhglsubEntity>();
	public List<ScQzhglsubEntity> getScQzhglsubList() {
		return scQzhglsubList;
	}
	public void setScQzhglsubList(List<ScQzhglsubEntity> scQzhglsubList) {
		this.scQzhglsubList = scQzhglsubList;
	}
