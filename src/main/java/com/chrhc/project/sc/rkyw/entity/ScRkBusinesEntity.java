 ...
 * @date 2015-08-03 15:48:37
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sc_rk_busines", schema = "")
@SuppressWarnings("serial")
public class ScRkBusinesEntity implements java.io.Serializable {
	/**主键*/
	...
	/**人口信息ID*/
	@Excel(name="人口信息ID")
	private java.lang.String rkxxId;
	/**业务ID*/
	@Excel(name="业务ID")
	 ...
	 */
	@Column(name ="RKXX_ID",nullable=true,length=36)
	public java.lang.String getRkxxId(){
		return this.rkxxId;
	}
	 ...
	 */
	public void setRkxxId(java.lang.String rkxxId){
		this.rkxxId = rkxxId;
	}
	/**
	 *方法: 取得java.lang.String
	 ...
	 */
	@Column(name ="BUSINESSCODE",nullable=true,length=36)
