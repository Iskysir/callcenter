 ...
 * @date 2015-11-04 15:24:15
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sc_disability", schema = "")
@SuppressWarnings("serial")
public class ScDisabilityEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="COMMUNITY",nullable=false,length=50)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  疾病
	 */
	@Column(name ="ILL",nullable=false,length=32)
