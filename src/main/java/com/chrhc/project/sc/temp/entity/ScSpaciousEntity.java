 ...
 * @date 2015-11-04 15:09:25
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sc_spacious", schema = "")
@SuppressWarnings("serial")
public class ScSpaciousEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  男方单位
	 */
	@Column(name ="M_UNIT",nullable=false,length=32)
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  离婚日期
	 */
	@Column(name ="LEAVE_DATE",nullable=false,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  出证次数
	 */
	@Column(name ="PRINT_NUM",nullable=true,length=32)
	public java.lang.String getPrintNum(){
		return this.printNum;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  出证次数
	 */
	public void setPrintNum(java.lang.String printNum){
