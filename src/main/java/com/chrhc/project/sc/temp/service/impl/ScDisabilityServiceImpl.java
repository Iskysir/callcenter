...
@Service("scDisabilityService")
@Transactional
public class ScDisabilityServiceImpl extends CommonServiceImpl implements ScDisabilityServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((ScDisabilityEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((ScDisabilityEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((ScDisabilityEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(ScDisabilityEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(ScDisabilityEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(ScDisabilityEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ScDisabilityEntity t){
 		...
 		sql  = sql.replace("#{ill}",String.valueOf(t.getIll()));
