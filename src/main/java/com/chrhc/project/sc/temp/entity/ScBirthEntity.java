 ...
 * @date 2015-11-04 15:23:47
 * @version V1.0   
 *
 */
@Entity
@Table(name = "sc_birth", schema = "")
@SuppressWarnings("serial")
public class ScBirthEntity implements java.io.Serializable {
	/**主键*/
	...
	/**出生日期*/
	@Excel(name="出生日期")
	private java.util.Date mBirthdayDate;
	/**配偶姓名*/
	@Excel(name="配偶姓名")
	private java.lang.String spouseName;
	/**结婚日期*/
	@Excel(name="结婚日期")
	private java.util.Date marryday;
	/**孩子姓名*/
	@Excel(name="孩子姓名")
	 ...
	 */
	@Column(name ="M_BIRTHDAY_DATE",nullable=false,length=32)
	public java.util.Date getMBirthdayDate(){
	 ...
	 */
	public void setMBirthdayDate(java.util.Date mBirthdayDate){
	 ...
	 */
	@Column(name ="MARRYDAY",nullable=false,length=32)
	public java.util.Date getMarryday(){
	 ...
	 */
	public void setMarryday(java.util.Date marryday){
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  生育日期
	 */
	@Column(name ="BIRTH_DATE",nullable=false,length=32)
	 ...
	 */
	@Column(name ="OBLIGATEC",nullable=true,length=50)
