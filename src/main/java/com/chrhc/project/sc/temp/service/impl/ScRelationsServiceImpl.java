...
@Service("scRelationsService")
@Transactional
public class ScRelationsServiceImpl extends CommonServiceImpl implements ScRelationsServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((ScRelationsEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((ScRelationsEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((ScRelationsEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(ScRelationsEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(ScRelationsEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(ScRelationsEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ScRelationsEntity t){
 		...
 		sql  = sql.replace("#{prove_name}",String.valueOf(t.getProveName()));
 		sql  = sql.replace("#{relationship}",String.valueOf(t.getRelationship()));
 		sql  = sql.replace("#{doc_typename}",String.valueOf(t.getDocTypename()));
 		sql  = sql.replace("#{community}",String.valueOf(t.getCommunity()));
 		...
 		sql  = sql.replace("#{prove_id}",String.valueOf(t.getProveId()));
