 ...
 */
@Entity
@Table(name = "sc_message", schema = "")
@SuppressWarnings("serial")
public class ScMessageEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="M_TYPE",nullable=true,length=20)
	 ...
	 */
	@Column(name ="RECEIVER",nullable=true,length=9999)
	 ...
	 */
	@Column(name ="P_TIME",nullable=true,length=50)
